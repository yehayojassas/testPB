...
import { fetchOptionItems, fetchProducts, fetchRestaurants } from '../lib/api.js';
...
export function ShopProvider({ children }) {
  ...
  useEffect(() => {
    Promise.all([fetchRestaurants(), fetchProducts(), fetchOptionItems()]).then(([r, p, o]) => {
      setRestaurants(r);
      setProducts(p);
      setOptionItems(o);
      setReady(true);
  ...
  const value = {
    ready, restaurants, products, optionItems,
